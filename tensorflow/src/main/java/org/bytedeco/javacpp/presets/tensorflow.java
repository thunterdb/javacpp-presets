...
@Properties(value = @Platform(value = {"linux", "macosx"}, compiler = "cpp11", define = "NDEBUG", include = {
        ...
        "tensorflow/core/framework/config.pb.h",
        ...
        "tensorflow/cc/ops/attention_ops.h",
        "tensorflow/cc/ops/const_op.h",
        ...
        "tensorflow/cc/ops/summary_ops.h",
...
public class tensorflow implements InfoMapper {
    public void map(InfoMap infoMap) {
        infoMap.put(new Info("tensorflow_adapters.h").skip())
               ...
               .put(new Info("tensorflow::gtl::InlinedVector<long long,4>").skip())
               .put(new Info("std::function<bool(constNode*)>").skip())
